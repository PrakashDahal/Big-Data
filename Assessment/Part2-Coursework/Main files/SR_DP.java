...
import org.apache.hadoop.mapreduce.lib.output.FileOutputFormat;
 ...
 public static class SR_DPMapper extends Mapper <Object, Text, Text, Text>  {
	...
	if (parts.length == 3 )
		...
		context.write(new Text(parts[0]), new Text(parts[3]));
	else
		context.write(new Text(parts[0]), new Text("0"));
		} // map
	} // PopMapper
 
	public static class SR_DPReducer extends Reducer <Text, Text, Text, Text> {
 ...
 public static void main(String[] args) throws Exception {
	...
	job.setJarByClass(SR_DP.class);
	job.setMapperClass(SR_DPMapper.class);
	job.setReducerClass(SR_DPReducer.class);
